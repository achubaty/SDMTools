#' Point in Polygon
#'
#' `pnt.in.poly` works out if 2D points lie within the boundaries of a
#' defined polygon. \cr \cr **Note:** Points that lie on the boundaries of
...
#' polypnts <- cbind(
#'   x = c(2, 3, 3.5, 3.5, 3, 4, 5, 4, 5, 5, 4, 3, 3, 3, 2, 2, 1, 1, 1, 1, 2),
