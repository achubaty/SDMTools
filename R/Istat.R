...
#'
#' `Istat` computes the I similarity statistic of Warren et al. 2008. It
#' is a method for defining niche overlap from predictions of species'
#' distributions. \cr \cr **NOTE:** it is assumed the input data are of the
...
#' <http://enmtools.blogspot.com.au/2010_09_01_archive.html>.
#'
...
#' tasc2 <- tasc + rnorm(n = 2500, mean = 25, sd = 15)
#' tasc2 <- abs(tasc2)
#' I <- Istat(tasc1, tasc2)
