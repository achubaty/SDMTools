...
#'
#' `COGravity` calculates the Centre of Gravity (or also known as Centre
#' of Mass) for point or raster spatial data.\cr \cr **Note:** NA data is
#' automatically ommitted from analysis.
#'
#' For raster-based data, if `wt` is missing, the values of the ascii are
...
COGravity <- function(x, y = NULL, z = NULL, wt = NULL) {
  ...
  } else if (inherits(x, "asc")) { # if x is of class 'asc'
